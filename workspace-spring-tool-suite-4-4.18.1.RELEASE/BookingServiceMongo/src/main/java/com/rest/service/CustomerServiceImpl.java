...
public class CustomerServiceImpl implements ICustomerService {
	...
	@Override
	public Customer updateCustomer(Customer cobj, String cid) throws CustomerNotFoundException {
	...
	@Override
	public Customer getCustomerById(String cid) throws CustomerNotFoundException {
		Optional<Customer> optional=this.cusrepo.findById(cid);
	...
	@Override
	public boolean delCustomer(String cid) throws CustomerNotFoundException {
		Optional<Customer> optional=this.cusrepo.findById(cid);
