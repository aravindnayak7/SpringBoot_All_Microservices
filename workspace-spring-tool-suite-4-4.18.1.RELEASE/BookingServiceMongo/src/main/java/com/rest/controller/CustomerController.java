...
public class CustomerController {
	...
	public ResponseEntity<?> updateCustomerHandler(@RequestBody Customer cobj,@PathVariable String cid)throws CustomerNotFoundException{
	...
	public ResponseEntity<?> getCustomerByIdHandler(@PathVariable String cid)throws CustomerNotFoundException{
	...
	public ResponseEntity<?> delCustomerHandler(@PathVariable String cid)throws CustomerNotFoundException{
