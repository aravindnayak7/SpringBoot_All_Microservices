...
public class EmployeeServiceImpl implements EmployeeService {
	...
	@Override
	public boolean validateEmployee(String empname, String password) throws EmployeeNotFoundException {
		// TODO Auto-generated method stub
		Employee emp=this.emprepository.validateEmployee(empname,password);
